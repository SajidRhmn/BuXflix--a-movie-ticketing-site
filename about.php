		...
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style="color:blueviolet; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								<div class="grid images_3_of_2">
									<img src="<?php echo $movie['image']; ?>" alt=""/>
								</div>
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:15px; color:#000;"><b>Cast : </b><?php echo $movie['cast']; ?></p>
									<p class="p-link" style="font-size:15px; colour:#2f4f4f;"><b>Release Date : </b><?php echo date('d-M-Y',strtotime($movie['release_date'])); ?></p>
									<p style="font-size:15px; color:#0047AB;"><?php echo $movie['desc']; ?></p>
							...
							<table class="table table-hover table-bordered text-center">
								<h3 style="2f4f4f;" class="text-center">Shows Available Now</h3>
								<thead>
										<tr>
							...
							<?php
								...
								while($shw=mysqli_fetch_array($s))
								{
									...
									$t=mysqli_query($con,"select * from theater where id='".$shw['theatre_id']."'");
									...
									<tr>
										...
										<td>
											...
											{
												$ttm=mysqli_query($con,"select  * from showtime where st_id='".$shh['st_id']."'");
